...
use Gus\TableBundle\Table\Pagination\Strategy\StrategyFactory;
use Gus\TableBundle\Table\Pagination\Strategy\StrategyInterface;
...
class PaginationExtension extends AbstractTwigExtension
{
	...
	public function getTablePaginationContent(Twig_Environment $environment, TableView $tableView)
	{
      ...
      'items'       => count($tableView->getRows()),
      'total_items' => $tableView->getTableOption(TableOptions::TOTAL_ITEMS)
		));
